...
export const careStories: CareStory[] = [
  ...
  { id: 'cs4', type: 'photo', mediaType: 'photo', imageUrl: 'https://images.unsplash.com/photo-1583337130417-13104dec14a3?w=600&h=400&fit=crop', title: 'Rani rescued from busy highway', body: 'A scared mother dog was safely moved from the highway median to a shelter near CMH Road.', fullBody: 'Rani, a pregnant mother dog, was spotted living dangerously on the median of a busy highway near CMH Road. Three Straytopia helpers coordinated a careful rescue over two days. Rani gave birth to 4 healthy puppies a week later.', badge: 'RESCUE', badgeTone: 'coral', helpers: ['K', 'V', 'M'], hearts: 38, reporter: 'Kavitha R.', respondent: 'Vikram P.', date: '5 days ago', location: 'CMH Road, Indiranagar' },

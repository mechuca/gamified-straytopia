...
export interface CareStory {
  id: string;
  type: 'rescue' | 'milestone' | 'before-after';
  title: string;
  body: string;
  fullBody: string;
  badge: string;
...
export const careStories: CareStory[] = [
  { id: 'cs1', type: 'rescue', title: 'Pluto found his forever home', body: 'After 3 months of care, the limping tan dog from the bakery was adopted by a family on 100 Feet Road.', fullBody: 'After 3 months of consistent care and feeding, Pluto — a limping tan dog who lived near the bakery on 100 Feet Road — was finally adopted by a loving family. The rescue started when a Straytopia user reported Pluto injured near the bakery. Three helpers coordinated feeding and medical check-ins until he was healthy enough for adoption. The family who adopted him already had another rescued dog, and they fell in love with Pluto\'s gentle nature during a community adoption event.', badge: 'RESCUE STORY', badgeTone: 'plum', helpers: ['A', 'R', 'S'], hearts: 47, reporter: 'Ananya K.', respondent: 'Rahul M.', date: '2 days ago', location: '100 Feet Road, Indiranagar' },
  { id: 'cs2', type: 'milestone', title: '5,000 meals served in Indiranagar', body: 'The community came together and fed over 5,000 street animals this month. Your contributions made this possible.', fullBody: 'This month, the Indiranagar care zone reached an incredible milestone: 5,000 meals served to street animals. This was made possible by 47 active helpers who logged their feeding missions through Straytopia. The most active feeding spots were near the bakery, the temple, and the park. Water refills also hit 1,200 this month. This community effort shows what consistent, coordinated care can achieve.', badge: 'MILESTONE', badgeTone: 'gold', helpers: [], hearts: 0, reporter: 'Straytopia', respondent: 'Indiranagar Zone', date: '1 week ago', location: 'Indiranagar Care Zone' },
  { id: 'cs3', type: 'before-after', title: 'Milo gained 2kg in 30 days', body: 'From severely underweight to a healthy, happy pup. Consistent feeding and care check-ins made the difference.', fullBody: 'Milo was found severely underweight near the metro station, weighing just 8kg. A Straytopia helper started daily feeding and water check-ins. Over 30 days, with consistent nutrition and monitoring, Milo gained 2kg and is now at a healthy 10kg. His coat has improved, he\'s more active, and he now greets helpers at the same spot every morning. This is what consistent care looks like.', badge: '30 DAY UPDATE', badgeTone: 'plum', helpers: [], hearts: 0, reporter: 'Meera S.', respondent: 'Meera S.', date: '3 days ago', location: 'Indiranagar Metro Station' },
  { id: 'cs4', type: 'rescue', title: 'Rani rescued from busy highway', body: 'A scared mother dog was safely moved from the highway median to a shelter near CMH Road. 3 Straytopia helpers coordinated the rescue.', fullBody: 'Rani, a pregnant mother dog, was spotted living dangerously on the median of a busy highway near CMH Road. Three Straytopia helpers — Kavitha, Vikram, and Meera — coordinated a careful rescue over two days. They first established trust by leaving food, then used a humane carrier to safely transport her to a nearby shelter. Rani gave birth to 4 healthy puppies a week later. All puppies are now being fostered.', badge: 'RESCUE STORY', badgeTone: 'coral', helpers: ['K', 'V', 'M'], hearts: 38, reporter: 'Kavitha R.', respondent: 'Vikram P.', date: '5 days ago', location: 'CMH Road, Indiranagar' },
  { id: 'cs5', type: 'milestone', title: '100 water points active in Bangalore', body: 'Straytopia community has set up and maintained 100 water refill points across the city. Every drop counts.', fullBody: 'The Straytopia community has reached another city-wide milestone: 100 active water refill points across Bangalore. These points are maintained by dedicated volunteers who refill bowls daily, especially during the hot summer months. The initiative started in Indiranagar and has now spread to Koramangala, HSR Layout, Whitefield, and beyond. If you want to set up a water point in your area, start a mission and mark your location.', badge: 'CITY MILESTONE', badgeTone: 'sky', helpers: [], hearts: 0, reporter: 'Straytopia', respondent: 'Bangalore Community', date: '1 week ago', location: 'Bangalore' },
  { id: 'cs6', type: 'before-after', title: 'Sheru recovered from injury', body: 'Hit by a scooter last month, Sheru is now walking again thanks to quick rescue reports and consistent care check-ins from neighbors.', fullBody: 'Sheru was hit by a scooter near the 80 Feet Road crossing last month. A passerby quickly filed a rescue report on Straytopia, and within hours, two helpers arrived to assess his condition. Sheru had a leg injury but no fractures. He was given basic first aid and moved to a safer spot away from traffic. Over the next three weeks, neighbors took turns feeding him and monitoring his recovery. Today, Sheru is walking normally and has returned to his usual spot — but now he greets helpers with a wagging tail.', badge: 'RECOVERY', badgeTone: 'jungle', helpers: ['P', 'A'], hearts: 52, reporter: 'Priya N.', respondent: 'Arjun D.', date: '4 days ago', location: '80 Feet Road, Indiranagar' },
  { id: 'cs7', type: 'milestone', title: '12,000 animals helped across India', body: 'From Bangalore to Mumbai, Delhi to Chennai — Straytopia helpers have reached 12,000 unique animals nationwide.', fullBody: 'Straytopia has officially helped 12,000 unique animals across India. What started as a small community in Bangalore has grown into a nationwide movement. The top cities by animal count are Bangalore (5,680), Mumbai (2,100), Delhi (1,800), and Chennai (1,200). But the real number is likely much higher — many helpers don\'t log every interaction. Every meal, every water refill, every rescue report counts. Thank you to every helper who made this possible.', badge: 'NATIONAL MILESTONE', badgeTone: 'gold', helpers: [], hearts: 0, reporter: 'Straytopia', respondent: 'India Community', date: '2 weeks ago', location: 'India' },
  { id: 'cs8', type: 'rescue', title: 'Kittens saved from monsoon flood', body: 'A litter of 5 kittens was rescued from a flooded drain in Domlur. All kittens are now safe with a foster family.', fullBody: 'During heavy monsoon rains, a Straytopia helper noticed a litter of 5 kittens trapped in a flooded drain near Domlur Lake. An SOS was triggered, and two rescue operators responded within 30 minutes. The kittens, just 3 weeks old, were carefully extracted and taken to a nearby foster home. All 5 kittens are now healthy, playful, and looking for permanent homes. The foster family has named them after the rain: Droplet, Puddle, Splash, Ripple, and Cloud.', badge: 'RESCUE STORY', badgeTone: 'plum', helpers: ['R', 'S'], hearts: 64, reporter: 'Rahul M.', respondent: 'Straytopia Rescue', date: '1 day ago', location: 'Domlur, Bangalore' },
];
